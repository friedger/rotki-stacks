...
import type { AccountManage } from '@/modules/accounts/blockchain/use-account-manage';
...
import ModuleActivator from '@/modules/accounts/ModuleActivator.vue';
